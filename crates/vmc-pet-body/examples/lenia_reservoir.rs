...
//!
//! これまでは「Lenia の場を予測する」実験をしてきた
//! (docs/experiments/collapse-prediction.md「パラメータと場の両方から崩壊の確率を当てる」など)。
//! その逆に、場そのものを計算資源として使う(リザバーコンピューティング)。入力を体への弱い
//! 摂動として注ぎ、場の非線形な力学に混ぜさせ、場の状態から線形の読み出しだけを学習して、
//! 過去の入力を当てさせる
//! (docs/experiments/collapse-prediction.md「Lenia の場をリザバーとして使えるか」)。
//!
