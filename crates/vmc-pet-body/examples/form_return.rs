...
//!
//! 「生き残る関数で表情を足せるか」(docs/DESIGN.md)で、S1s と 2S1v は生き残る関数 P の中心を
//! −0.25σ へ動かすだけで止まった形(ドーナツ形・歯車形)に移り、P を戻しても戻らなかった。
//! 試したのは「戻す」だけだったので、逆向きのきっかけを与えて元の姿に戻せるかを確かめる
//! (docs/DESIGN.md「別の形から戻る帰り道はあるか」)。戻せるなら、行きと帰りに別のきっかけを
//! 使う2状態の表現になる。
//!
