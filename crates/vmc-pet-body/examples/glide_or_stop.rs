...
//!
//! 「別の形から戻る帰り道はあるか」(docs/experiments/expression-axes.md)で、止まった
//! ドーナツ形の S1s は、どのきっかけでも、ほかの生物の値を経由しても、滑る姿へ戻らなかった。
//! 滑る S1s は animals.json の初期パターンから育てたときにだけ現れる「谷の狭い形」で、止まった
//! 形のほうが広い範囲から流れ込む「谷の深い形」なのではないか、という仮説を確かめる
//! (docs/experiments/expression-axes.md「滑る S1s は谷の狭い形か」)。
//!
